...
const FidsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         *
         */
        fetchFids: async (pageSize, reverse, pageToken, options = {}) => {
...
const FidsApiFp = function (configuration) {
    ...
    return {
         ...
         *
         */
        async fetchFids(pageSize, reverse, pageToken, options) {
            var _a, _b, _c;
...
class FidsApi extends base_1.BaseAPI {
     ...
     */
    fetchFids(requestParameters = {}, options) {
        return (0, exports.FidsApiFp)(this.configuration).fetchFids(requestParameters.pageSize, requestParameters.reverse, requestParameters.pageToken, options).then((request) => request(this.axios, this.basePath));
    }
}
