 ...
 * @enum {string}
 */
export declare const FarcasterNetwork: {
    readonly Mainnet: "FARCASTER_NETWORK_MAINNET";
    readonly Testnet: "FARCASTER_NETWORK_TESTNET";
    readonly Devnet: "FARCASTER_NETWORK_DEVNET";
};
