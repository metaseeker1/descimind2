...
import { type CheckBalanceAgainstTransactionParameters, type CheckBalanceAgainstTransactionReturnType } from '../../actions/public/checkBalanceAgainstTransaction.js';
...
import { type EstimateContractGasAndCollateralParameters, type EstimateContractGasAndCollateralReturnType } from '../../actions/public/estimateContractGasAndCollateral.js';
import { type EstimateGasAndCollateralParameters, type EstimateGasAndCollateralReturnType } from '../../actions/public/estimateGasAndCollateral.js';
import { type EstimateMaxPriorityFeePerGasReturnType } from '../../actions/public/estimateMaxPriorityFeePerGas.js';
import { type GetChainAccountParameters, type GetChainAccountReturnType } from '../../actions/public/getAccount.js';
import { type GetAccountPendingInfoParameters, type GetAccountPendingInfoReturnType } from '../../actions/public/getAccountPendingInfo.js';
import { type GetAccountPendingTransactionsParameters, type GetAccountPendingTransactionsReturnType } from '../../actions/public/getAccountPendingTransactions.js';
import { type GetAccumulateInterestRateParameters, type GetAccumulateInterestRateReturnType } from '../../actions/public/getAccumulateInterestRate.js';
import { type GetAdminParameters, type GetAdminReturnType } from '../../actions/public/getAdmin.js';
import { type GetBalanceParameters, type GetBalanceReturnType } from '../../actions/public/getBalance.js';
import { type GetBastBlockHashReturn } from '../../actions/public/getBastBlockHash.js';
import { type GetBlockParameters, type GetBlockReturnType } from '../../actions/public/getBlock.js';
import { type GetBlockByHashWithPivotAssumptionParameters, type GetBlockByHashWithPivotAssumptionReturnType } from '../../actions/public/getBlockByHashWithPivotAssumption.js';
import { type GetBlockRewardInfoParameters, type GetBlockRewardInfoReturnType } from '../../actions/public/getBlockRewardInfo.js';
import { type GetBlocksByEpochParameters, type GetBlocksByEpochReturnType } from '../../actions/public/getBlocksByEpoch.js';
import { type GetChainIdReturnType } from '../../actions/public/getChainId.js';
import { type GetClientVersionReturnType } from '../../actions/public/getClientVersion.js';
import { type GetCodeParameters, type GetCodeReturnType } from '../../actions/public/getCode.js';
import { type GetCollateralInfoParameters, type GetCollateralInfoReturnType } from '../../actions/public/getCollateralInfo.js';
import { type GetCollateralForStorageParameters, type GetCollateralForStorageReturnType } from '../../actions/public/getCollaterlForStorage.js';
import { type GetConfirmationRiskByHashParameters, type GetConfirmationRiskByHashReturnType } from '../../actions/public/getConfirmationRiskByHash.js';
import { type GetContractEventsParameters, type GetContractEventsReturnType } from '../../actions/public/getContractEvents.js';
import { type GetDepositListParameters, type GetDepositListReturnType } from '../../actions/public/getDepositList.js';
import { type GetEpochNumberParameters, type GetEpochNumberReturnType } from '../../actions/public/getEpochNumber.js';
import { type GetEpochReceiptsParameters, type GetEpochReceiptsReturnType } from '../../actions/public/getEpochReceipts.js';
import { type GetFeeBurntReturnType } from '../../actions/public/getFeeBurnt.js';
...
import { type GetInterestRateParameters, type GetInterestRateReturnType } from '../../actions/public/getInterestRate.js';
import { type GetLogsParameters, type GetLogsReturnType } from '../../actions/public/getLogs.js';
import { type GetNextNonceParameters, type GetNextNonceReturnType } from '../../actions/public/getNextNonce.js';
import { type GetParamsFormVoteParameters, type GetParamsFormVoteReturnType } from '../../actions/public/getParamsFromVote.js';
import { type GetPoSAccountParameters, type GetPoSAccountReturnType } from '../../actions/public/getPoSAccount.js';
import { type GetPoSBlockParameters, type GetPosBlockReturnType } from '../../actions/public/getPoSBlock.js';
import { type GetPoSCommitteeParameters, type GetPoSCommitteeReturnType } from '../../actions/public/getPoSCommittee.js';
import { type GetPoSEconomicsParameters, type GetPoSEconomicsReturnType } from '../../actions/public/getPoSEconomics.js';
import { type GetPoSRewardByEpochParameters, type GetPoSRewardByEpochReturnType } from '../../actions/public/getPoSRewardByEpoch.js';
import { type GetPoSRewardsParameters, type GetPoSRewardsReturnType } from '../../actions/public/getPoSRewards.js';
import { type GetPoSStatusReturnType } from '../../actions/public/getPoSStatus.js';
import { type GetPoSTransactionParameters, type GetPoSTransactionReturnType } from '../../actions/public/getPoSTransactionByNumber.js';
import { type GetSkippedBlocksByEpochParameters, type GetSkippedBlocksByEpochReturnType } from '../../actions/public/getSkippedBlocksByEpoch.js';
import { type GetSponsorInfoParameters, type GetSponsorInfoReturnType } from '../../actions/public/getSponsorInfo.js';
import { type GetStakingBalanceParameters, type GetStakingBalanceReturnType } from '../../actions/public/getStakingBalance.js';
import { type GetStatusReturnType } from '../../actions/public/getStatus.js';
import { type GetStorageAtParameters, type GetStorageAtReturnType } from '../../actions/public/getStorageAt.js';
import { type GetStorageRootParameters, type GetStorageRootReturnType } from '../../actions/public/getStorageRoot.js';
import { type GetSupplyInfoReturnType } from '../../actions/public/getSupplyInfo.js';
...
import { type GetTxPoolNextNonceParameters, type GetTxPoolNextNonceReturnType } from '../../actions/public/getTxPoolNextNonce.js';
import { type GetVoteListParameters, type GetVoteListReturnType } from '../../actions/public/getVoteList.js';
...
import { type TraceBlockParameters, type TraceBlockReturnType } from '../../actions/public/traceBlock.js';
import { type TraceTransactionParameters, type TraceTransactionReturnType } from '../../actions/public/traceTransaction.js';
...
import { type WatchEpochNumberParameters, type WatchEpochNumberReturnType } from '../../actions/public/watchEpochNumber.js';
...
export type PublicActions<_TTransport extends Transport = Transport, TChain extends Chain | undefined = Chain | undefined, _TAccount extends Account | undefined = Account | undefined> = {
    /**
     ...
     */
    getBlock: <TIncludeTransactions extends boolean = false, TEpochTag extends 'latest_mined' | 'latest_state' | 'latest_confirmed' | 'latest_checkpoint' | 'earliest' = 'latest_state'>(args?: GetBlockParameters<TIncludeTransactions, TEpochTag>) => Promise<GetBlockReturnType<TChain, TIncludeTransactions, TEpochTag>>;
    /**
     ...
     */
    getEpochNumber: (args?: GetEpochNumberParameters) => Promise<GetEpochNumberReturnType>;
    /**
     ...
     */
    getBlocksByEpoch: (args?: GetBlocksByEpochParameters | undefined) => Promise<GetBlocksByEpochReturnType>;
    /**
     ...
     */
    getStakingBalance: (args: GetStakingBalanceParameters) => Promise<GetStakingBalanceReturnType>;
    /**
     ...
     */
    getCollateralForStorage: (args: GetCollateralForStorageParameters) => Promise<GetCollateralForStorageReturnType>;
    /**
     ...
     */
    getStorageRoot: (args: GetStorageRootParameters) => Promise<GetStorageRootReturnType>;
    /**
     ...
     */
    getSponsorInfo: (args: GetSponsorInfoParameters) => Promise<GetSponsorInfoReturnType>;
    /**
     ...
     */
    estimateGasAndCollateral: (args: EstimateGasAndCollateralParameters) => Promise<EstimateGasAndCollateralReturnType>;
    /**
     ...
     */
    getLogs: <const abiEvent extends AbiEvent | undefined = undefined, const abiEvents extends readonly AbiEvent[] | readonly unknown[] | undefined = abiEvent extends AbiEvent ? [abiEvent] : undefined, strict extends boolean | undefined = undefined>(args?: GetLogsParameters<abiEvent, abiEvents, strict> | undefined) => Promise<GetLogsReturnType<abiEvent, abiEvents, strict>>;
    /**
     ...
     */
    getTransactionReceipt: (args: GetTransactionReceiptParameters) => Promise<GetTransactionReceiptReturnType>;
    /**
     ...
     */
    getAccount: (args: GetChainAccountParameters) => Promise<GetChainAccountReturnType>;
    /**
     ...
     */
    getInterestRate: (args: GetInterestRateParameters) => Promise<GetInterestRateReturnType>;
    /**
     ...
     */
    getAccumulateInterestRate: (args: GetAccumulateInterestRateParameters) => Promise<GetAccumulateInterestRateReturnType>;
    /**
     ...
     */
    checkBalanceAgainstTransaction: (args: CheckBalanceAgainstTransactionParameters) => Promise<CheckBalanceAgainstTransactionReturnType>;
    /**
     ...
     */
    getSkippedBlocksByEpoch: (args?: GetSkippedBlocksByEpochParameters) => Promise<GetSkippedBlocksByEpochReturnType>;
    /**
     ...
     */
    getConfirmationRiskByHash: (args: GetConfirmationRiskByHashParameters) => Promise<GetConfirmationRiskByHashReturnType>;
    /**
     ...
     */
    getBlockRewardInfo: (args?: GetBlockRewardInfoParameters) => Promise<GetBlockRewardInfoReturnType>;
    /**
     ...
     */
    getBlockByHashWithPivotAssumption: (args: GetBlockByHashWithPivotAssumptionParameters) => Promise<GetBlockByHashWithPivotAssumptionReturnType>;
    /**
     ...
     */
    getDepositList: (args: GetDepositListParameters) => Promise<GetDepositListReturnType>;
    /**
     ...
     */
    getAccountPendingInfo: (args: GetAccountPendingInfoParameters) => Promise<GetAccountPendingInfoReturnType>;
    /**
     ...
     * @returns
     */
    getAccountPendingTransactions: (args: GetAccountPendingTransactionsParameters) => Promise<GetAccountPendingTransactionsReturnType>;
    /**
     ...
     */
    getPoSEconomics: (args?: GetPoSEconomicsParameters) => Promise<GetPoSEconomicsReturnType>;
    /**
     ...
     */
    getPoSRewardByEpoch: (args: GetPoSRewardByEpochParameters) => Promise<GetPoSRewardByEpochReturnType>;
    /**
     ...
     */
    getParamsFromVote: (args?: GetParamsFormVoteParameters) => Promise<GetParamsFormVoteReturnType>;
    /**
     ...
     */
    getFilterChanges: (args: GetFilterChangesParameters) => Promise<GetFilterChangesReturnType>;
    /**
     ...
     */
    getFilterLogs: <const abi extends Abi | readonly unknown[] | undefined, eventName extends string | undefined, strict extends boolean | undefined = undefined>(args: GetFilterLogsParameters<abi, eventName, strict>) => Promise<GetFilterLogsReturnType<abi, eventName, strict>>;
    /**
     ...
     */
    getCollateralInfo: (args?: GetCollateralInfoParameters) => Promise<GetCollateralInfoReturnType>;
    /**
     ...
     */
    getTxPoolNextNonce: (args: GetTxPoolNextNonceParameters) => Promise<GetTxPoolNextNonceReturnType>;
    /**
     ...
     */
    getPoSCommittee: (args?: GetPoSCommitteeParameters) => Promise<GetPoSCommitteeReturnType>;
    /**
     ...
     */
    getPoSRewards: (args: GetPoSRewardsParameters) => Promise<GetPoSRewardsReturnType>;
    /**
     ...
     */
    getPoSTransactionByNumber: (args: GetPoSTransactionParameters) => Promise<GetPoSTransactionReturnType>;
    /**
     ...
     */
    getEpochReceipts: (args?: GetEpochReceiptsParameters) => Promise<GetEpochReceiptsReturnType>;
    /**
     ...
     */
    createContractEventFilter: <const abi extends Abi | readonly unknown[], eventName extends ContractEventName<abi> | undefined, args extends MaybeExtractEventArgsFromAbi<abi, eventName> | undefined, strict extends boolean | undefined = undefined>(args: CreateContractEventFilterParameters<abi, eventName, args, strict>) => Promise<CreateContractEventFilterReturnType<abi, eventName, args, strict>>;
    /**
     *
...
export declare function publicActions<TTransport extends Transport = Transport, TChain extends Chain | undefined = Chain | undefined, TAccount extends Account<Address> | undefined = Account<Address> | undefined>(client: Client<TTransport, TChain, TAccount>): PublicActions<TTransport, TChain, TAccount>;
