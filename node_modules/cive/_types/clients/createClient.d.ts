...
export type ClientConfig<transport extends Transport = Transport, chain extends Chain | undefined = Chain | undefined, accountOrAddress extends Account | Address | undefined = Account | Address | undefined, rpcSchema extends RpcSchema | undefined = undefined> = {
    ...
    ccipRead?: {
         ...
         */
        request?: (parameters: CcipRequestParameters) => Promise<Hex>;
    } | false | undefined;
...
type ExtendableProtectedActions<transport extends Transport = Transport, chain extends Chain | undefined = Chain | undefined, account extends Account | undefined = Account | undefined> = Pick<PublicActions<transport, chain, account>, 'getTransaction' | 'getBlock' | 'getBastBlockHash' | 'getEpochNumber' | 'getGasPrice'> & Pick<WalletActions<chain, account>, 'sendTransaction' | 'writeContract'>;
