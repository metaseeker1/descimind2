 ...
 * @returns
 */
export declare function getBastBlockHash<TChain extends Chain | undefined>(client: Client<Transport, TChain>): Promise<GetBastBlockHashReturn>;
//# sourceMappingURL=getBastBlockHash.d.ts.map