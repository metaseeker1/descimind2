...
export type GetChainAccountErrorType = RequestErrorType | NumberToHexErrorType | ErrorType;
export declare function getAccount<TChain extends Chain | undefined>(client: Client<Transport, TChain>, { address, epochNumber, epochTag, }: GetChainAccountParameters): Promise<ChainAccount>;
