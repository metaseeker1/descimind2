...
import type { Abi, AbiFunction, AbiStateMutability, Address } from '../../types/abitype.js';
...
import type { IsNarrowable, Prettify, UnionEvaluate, UnionOmit } from '../../types/utils.js';
...
} & ContractFunctionParameters<abi, 'nonpayable' | 'payable', functionName, args> & UnionOmit<CallParameters<derivedChain>, 'account' | 'batch' | 'to' | 'data' | 'value'> & GetMutabilityAwareValue<abi, 'nonpayable' | 'payable', functionName, CallParameters<derivedChain> extends CallParameters ? CallParameters<derivedChain>['value'] : CallParameters['value'], args>;
