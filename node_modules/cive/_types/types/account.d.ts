...
export type { Account, JsonRpcAccount, LocalAccount, } from '../accounts/types.js';
...
export type AccountPendingTransaction<TQuantity = bigint, TTransaction = Transaction | RpcTransaction> = {
    firstTxStatus: {
