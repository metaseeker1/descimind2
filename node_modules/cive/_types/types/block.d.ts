...
export type Block<TQuantity = bigint, _TIncludeTransactions extends boolean = boolean, TEpochTag extends EpochTag | undefined = undefined, _TTransaction = Transaction<bigint, number, TEpochTag extends 'latest_state' ? true : false>> = {
    /**
     ...
     */
    gasUsed: TEpochTag extends 'earliest' | 'latest_checkpoint' | 'latest_mined' ? null : TQuantity;
    /**
     *  hash of the block.
     */
    hash: Hash;
     ...
     */
    powQuality: TEpochTag extends 'latest_checkpoint' | 'latest_mined' ? null : Hash;
    /**
    ...
    /** Base fee per gas */
    baseFeePerGas: TEpochTag extends 'earliest' | 'latest_checkpoint' ? null : TQuantity;
};
export type EpochTag = 'earliest' | 'latest_checkpoint' | 'latest_finalized' | 'latest_confirmed' | 'latest_state' | 'latest_mined';
