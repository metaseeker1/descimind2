...
export type TransactionReceipt<TQuantity = bigint, TIndex = number, TOutcomeStatus = 'success' | 'failed' | 'skipped', TType = TransactionType> = {
    /**
...
export type Transaction<TQuantity = bigint, TIndex = number, TPending extends boolean = boolean> = OneOf<TransactionLegacy<TQuantity, TIndex, TPending> | TransactionEIP2930<TQuantity, TIndex, TPending> | TransactionEIP1559<TQuantity, TIndex, TPending>>;
...
export type TransactionRequest<TQuantity = bigint, TIndex = number> = OneOf<TransactionRequestLegacy<TQuantity, TIndex> | TransactionRequestEIP2930<TQuantity, TIndex> | TransactionRequestEIP1559<TQuantity, TIndex>>;
...
export type TransactionSerialized<TType extends TransactionType = TransactionType, result = (TType extends 'eip1559' ? TransactionSerializedEIP1559 : never) | (TType extends 'eip2930' ? TransactionSerializedEIP2930 : never) | (TType extends 'legacy' ? TransactionSerializedLegacy : never)> = IsNever<result> extends true ? TransactionSerializedGeneric : result;
...
export type TransactionSerializable<TQuantity = bigint, TIndex = number> = OneOf<TransactionSerializableLegacy<TQuantity, TIndex> | TransactionSerializableEIP2930<TQuantity, TIndex> | TransactionSerializableEIP1559<TQuantity, TIndex>>;
