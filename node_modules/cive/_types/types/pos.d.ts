...
export type PoSTransactionTypeAndPayload<TQuantity = bigint> = PoSTransactionRegisterType | PoSTransactionElectionType<TQuantity> | PoSTransactionUpdateVotingPowerType<TQuantity> | PoSTransactionRetireType<TQuantity> | PoSTransactionPivotDecisionType<TQuantity> | PoSTransactionDisputeType;
