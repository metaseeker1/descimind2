...
import type { PoSAccount, PoSBlock, PoSCommittee, PoSRewards, PoSStatus, PoSTransaction } from './pos.js';
...
import type { TransactionEIP1559, TransactionEIP2930, TransactionLegacy, TransactionReceipt, TransactionRequestEIP1559, TransactionRequestEIP2930, TransactionRequestLegacy, TransactionType } from './transaction.js';
import type { OneOf, UnionOmit } from './utils.js';
import type { Vote } from './vote.js';
export type { Quantity };
export type OutcomeStatus = '0x0' | '0x1' | '0x2';
export type RpcTransaction<TPending extends boolean = boolean> = UnionOmit<OneOf<TransactionLegacy<Quantity, Index, TPending, '0x0'> | TransactionEIP2930<Quantity, Index, TPending, '0x1'> | TransactionEIP1559<Quantity, Index, TPending, '0x2'>>, 'yParity'>;
export type RpcBlock<TBlockTag extends EpochTag = EpochTag, TIncludeTransactions extends boolean = boolean, TTransaction = RpcTransaction<TBlockTag extends 'latest_mined' ? true : false>> = Block<Quantity, TIncludeTransactions, TBlockTag, TTransaction>;
export type RpcEpochNumber = EpochNumber<Quantity>;
export type RpcSponsor = Sponsor<Quantity>;
export type RpcTransactionRequest = OneOf<TransactionRequestLegacy<Quantity, Index, '0x0'> | TransactionRequestEIP2930<Quantity, Index, '0x1'> | TransactionRequestEIP1559<Quantity, Index, '0x2'>>;
...
export type RpcTransactionReceipt = TransactionReceipt<Quantity, Index, OutcomeStatus, TransactionType>;
...
export type RpcAccountPendingTransaction = AccountPendingTransaction<Quantity, RpcTransaction>;
