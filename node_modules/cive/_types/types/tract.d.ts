...
export type TraceActions<TQuantity = bigint> = TraceCallAction<TQuantity> | TraceCreateAction<TQuantity> | TraceCallResultActon<TQuantity> | TraceCreateResultAction<TQuantity> | TraceInternalTransferActionAction;
