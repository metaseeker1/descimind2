...
const watchEpochNumber_js_1 = require("./watchEpochNumber.js");
async function waitForTransactionReceipt(client, { confirmations = 1, hash, onReplaced, pollingInterval = client.pollingInterval, retryCount = 6, retryDelay = ({ count }) => ~~(1 << count) * 200, timeout, epochTag = 'latest_state', }) {
    ...
    return new Promise((resolve, reject) => {
        ...
        const _unobserve = (0, observe_js_1.observe)(observerId, { onReplaced, resolve, reject }, (emit) => {
            const _unwatch = (0, getAction_js_1.getAction)(client, watchEpochNumber_js_1.watchEpochNumber, 'watchEpochNumber')({
                emitMissed: true,
                emitOnBegin: true,
                poll: true,
                pollingInterval,
