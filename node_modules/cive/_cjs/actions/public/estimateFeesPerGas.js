...
async function internal_estimateFeesPerGas(client, args) {
    ...
    if (baseFeeMultiplier < 1)
        throw new viem_1.BaseFeeScalarError();
    ...
    if (type === 'eip1559') {
        ...
        const maxPriorityFeePerGas = typeof request?.maxPriorityFeePerGas === 'bigint'
            ...
            : await (0, getAction_js_1.getAction)(client, estimateMaxPriorityFeePerGas_js_1.estimateMaxPriorityFeePerGas, 'estimateMaxPriorityFeePerGas')({});
