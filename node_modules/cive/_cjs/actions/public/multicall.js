...
const errors_js_1 = require("../../types/abitype/errors.js");
...
async function multicall(client, parameters) {
    ...
    for (let i = 0; i < contracts.length; i++) {
        ...
        try {
            const callData = (0, index_js_1.encodeFunctionData)({ abi, args, functionName });
    ...
    for (let i = 0; i < aggregate3Results.length; i++) {
        ...
        for (let j = 0; j < aggregate3Result.length; j++) {
            ...
            try {
                ...
                const result = (0, index_js_1.decodeFunctionResult)({
                    abi,
                    args,
                    data: returnData,
                    functionName,
    ...
    if (results.length !== contracts.length)
        throw new errors_js_1.BaseError('multicall results mismatch');
    return results;
}
