...
const estimateContractGasAndCollateral_js_1 = require("./public/estimateContractGasAndCollateral.js");
            ...
            contract.estimateGasAndCollateral = new Proxy({}, {
                get(_, functionName) {
                    return (...parameters) => {
                        ...
                        return (0, getAction_js_1.getAction)(client, estimateContractGasAndCollateral_js_1.estimateContractGasAndCollateral, 'estimateContractGasAndCollateral')({
                            abi,
                            address,
                            functionName,
                            args,
