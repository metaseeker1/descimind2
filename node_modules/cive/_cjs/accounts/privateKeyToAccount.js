...
function privateKeyToAccount(privateKey, { networkId, verbose = false, }) {
    const publicKey = (0, viem_1.toHex)(secp256k1_1.secp256k1.getPublicKey(privateKey.slice(2), false));
    const address = (0, publicKeyToAddress_js_1.publicKeyToAddress)({
        publicKey,
        networkId,
        verbose,
    });
