...
exports.formatTract = formatTract;
exports.formatTransactionTraces = formatTransactionTraces;
exports.formatTraceBlock = formatTraceBlock;
function formatTract(trace) {
    const result = {
        ...trace,
...
function formatTransactionTraces(transactionTraces) {
    const result = {
        ...transactionTraces,
...
function formatTraceBlock(block) {
    const result = {
        ...block,
