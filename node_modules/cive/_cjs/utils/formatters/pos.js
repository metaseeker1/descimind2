...
exports.formatPoSStatus = formatPoSStatus;
exports.formatPoSAccount = formatPoSAccount;
exports.formatPoSCommittee = formatPoSCommittee;
exports.formatPoSBlock = formatPoSBlock;
exports.formatPosRewards = formatPosRewards;
exports.formatPoSTransaction = formatPoSTransaction;
function formatPoSStatus(status) {
    const result = {
        ...status,
...
function formatPoSAccount(account) {
...
function formatPoSCommittee(committee) {
...
function formatPosRewards(rewards) {
    const result = {
        ...rewards,
...
function formatPoSTransaction(tx) {
    const result = {
        ...tx,
