...
function hashTypedData(parameters) {
    ...
    const types = {
        CIP23Domain: (0, typedData_js_1.getTypesForCIP23Domain)({ domain }),
        ...parameters.types,
    };
    ...
    return (0, viem_1.keccak256)((0, viem_1.concat)(parts));
}
...
function encodeField({ types, name, type, value, }) {
    if (types[type] !== undefined) {
        return [
            { type: 'bytes32' },
            (0, viem_1.keccak256)(encodeData({ data: value, primaryType: type, types })),
        ];
    }
    if (type === 'bytes') {
    ...
    if (type.lastIndexOf(']') === type.length - 1) {
        ...
        return [
            { type: 'bytes32' },
            (0, viem_1.keccak256)((0, encodeAbiParameters_js_1.encodeAbiParameters)(typeValuePairs.map(([t]) => t), typeValuePairs.map(([, v]) => v))),
        ];
    }
    return [{ type }, value];
}
