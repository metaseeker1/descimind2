...
const abi_js_1 = require("../../types/abi.js");
const isAddress_js_1 = require("../address/isAddress.js");
function getAbiItem(parameters) {
    const { abi, args = [], name } = parameters;
    const isSelector = (0, viem_1.isHex)(name, { strict: false });
    const abiItems = abi.filter((abiItem) => {
        if (isSelector) {
            if (abiItem.type === 'function')
                return (0, viem_1.toFunctionSelector)(abiItem) === name;
            if (abiItem.type === 'event')
                return (0, viem_1.toEventSelector)(abiItem) === name;
            return false;
        }
