import { hexToBytes, padHex, stringToBytes, toHex } from 'viem';
...
export function hexAddressToBase32({ hexAddress, networkId, verbose, }) {
    ...
    const payload5Bits = convertBit(new Uint8Array([VERSION_BYTE, ...hexBuffer]), 8, 5, true);
    const checksumBigInt = polyMod(new Uint8Array([
        ...netName5Bits,
        0,
        ...payload5Bits,
        0,
